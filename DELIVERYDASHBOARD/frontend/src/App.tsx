...
function App() {
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      const res = await fetch('https://delivery.peghouse.in/api/auth/profile', {
  ...
  const LoginForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      e.preventDefault();
      try {
        const response = await fetch('https://delivery.peghouse.in/api/auth/login', {
          method: 'POST',
  ...
  const RegisterForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        const response = await fetch('https://delivery.peghouse.in/api/auth/register', {
          method: 'POST',
          body: formDataToSend
        });

...
function App() {
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      const res = await fetch('https://delivery.drnkly.com/api/auth/profile', {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        ...
        const res = await fetch('https://delivery.drnkly.com/api/orders/handedOver', {
          headers: {
...
const handleItemAction = async (orderId: string, itemId: string, action: 'accept' | 'decline' | 'deliver' | 'reject') => {
  if (action === 'accept') {
    try {
      ...
      const res = await fetch(`https://delivery.drnkly.com/api/orders/${orderId}/items/${itemId}/accept`, {
        method: 'PUT',
        headers: {
    ...
    try {
      ...
      const res = await fetch(`https://delivery.drnkly.com/api/orders/${orderId}/items/${itemId}/reject`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
    ...
    try {
      ...
      const res = await fetch(`https://delivery.drnkly.com/api/orders/${orderId}/items/${itemId}/deliver`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
          Authorization: `Bearer ${token}`,
  ...
  const LoginForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      e.preventDefault();
      try {
        const response = await fetch('https://delivery.drnkly.com/api/auth/login', {
          method: 'POST',
  ...
  const RegisterForm = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
      ...
      try {
        const response = await fetch('https://delivery.drnkly.com/api/auth/register', {
          method: 'POST',
          body: formDataToSend
        });

          ...
          <div className="border rounded-lg divide-y">
            {issues.map((issue) => (
              <button
                ...
                className={`flex justify-between items-center p-4 text-sm sm:text-base w-full text-left hover:bg-gray-50 transition ${selectedTicket === issue._id ? 'bg-gray-100' : ''
                  }`}
              >
                <div>
            ...
            <div className="space-y-2 text-sm sm:text-base">
              ...
              {selectedIssue.file && (
                <p>
                  ...
                  <a
                    href={`${API_BASE_URL}/${selectedIssue.file}`}
                    target="_blank"
